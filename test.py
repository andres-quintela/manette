...
if __name__ == '__main__':
    ...
    explo_policy = ExplorationPolicy(args.egreedy, args.epsilon, args.softmax_temp, args.use_dropout, args.keep_percentage, args.annealed, args.pwyx_net, args.play_in_colours)
